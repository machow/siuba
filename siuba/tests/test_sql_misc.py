from siuba import _, group_by, mutate
...
@backend_sql
def test_raw_sql_grouped(backend, df):
    assert_equal_query(
            df,
...
@backend_sql
def test_raw_sql_refer_previous_raise_dberror(backend, df):
