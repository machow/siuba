...
ops_infix_methods = Namespace(
    ...
    divmod        = operation('divmod', 'elwise', 2),
    ...
    rdivmod       = operation('rdivmod', 'elwise', 2),
...
ops_dt = Namespace(
    ...
    days             = operation('days', 'elwise', 1, True, 'dt'),
    ...
    microseconds     = operation('microseconds', 'elwise', 1, True, 'dt'),
    ...
    nanoseconds      = operation('nanoseconds', 'elwise', 1, True, 'dt'),
    ...
    seconds          = operation('seconds', 'elwise', 1, True, 'dt'),
...
ops_dt_plain = Namespace(
    ...
    between_time      = operation('between_time', 'elwise', 1),

    asof              = operation('asof', 'window', 1),
    shift             = operation('shift', 'window', 1),
    tshift            = operation('tshift', 'window', 1),
...
ops_attrs = Namespace(
    ...
    is_copy      = operation('is_copy', 'singleton', 1, True, None),
...
ops_cat = Namespace(
    add_categories = operation('add_categories', 'window', 1, False, 'cat'),
    ...
    remove_categories = operation('remove_categories', 'window', 1, False, 'cat'),
...
ops_convert = Namespace(
    ...
    infer_objects = operation('infer_objects', 'window', 1),
...
ops_index = Namespace(
    ...
    drop_duplicates = operation('drop_duplicates', 'window', 1),
    ...
    first = operation('first', 'window', 1),
