...
siuba is a port of [dplyr](https://github.com/tidyverse/dplyr) and other R libraries. ("siuba" is [Cantonese](http://www.cantonese.sheik.co.uk/dictionary/words/9139/) for "minibus".) It supports a tabular data analysis workflow centered on 5 common actions:
