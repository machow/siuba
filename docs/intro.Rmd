...
Fortunately, plotnine supports siuba's style of piping, so is easy to plug in to!
...
* Interested in wrangling data right away? Check out the [data analysis guide](guide_analysis.html).
* Curious how to program and extend siuba? Check out the [programming guide](guide_programming.html).
